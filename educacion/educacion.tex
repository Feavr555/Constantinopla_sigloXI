...
%Para empezar con la educación de Constantinopla, se va a dividir en 
%dos partes principales, el rector de la universidad de Constantinopla, 
%y el emperador del imperio. De forma que se va a poder estudiar el 
%programa de estudio y que obra hizo el “estado”.

%Modificación de la primer corrección
...
Para ir viendo el estilo de pedagogía que quería dar en la 
...
\textit{“Fiel a estas ideas, Psellos estableció en la Universidad de 
...
A continuación, trataré de la oratoria con oratoria:
